...
# =======================================================================================================
def load_audio(audio_path,Fs = None,mono = True,normalization = True):
...
# =======================================================================================================
# Function: get_audio_segments(...)
# Description: This function splits an audio signal into segments
# =======================================================================================================
def get_audio_segments(audio,Fs,measures):
    ...
    for bar in range(num_of_measures):
        ...
        # Segment Samples
        start_sample = seconds2samples(start_sec,Fs,'ceil')
        end_sample = seconds2samples(end_sec,Fs,'floor')
...
# =======================================================================================================
def get_spectrogram(audio,Fs,window_length,overlap_length,fft_length,winType = 'hann',padding = True,start_sec = 0):
    ...
    f,t,s = stft(audio,Fs,winType,window_length,overlap_length,fft_length,boundary = boundary)
...
# =======================================================================================================
def get_oss(s,t,smoothing = False,normalization = False):
...
# =======================================================================================================
def seconds2samples(seconds,Fs,rounding = 'round'):
