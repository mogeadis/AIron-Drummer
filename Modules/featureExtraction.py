...
# =======================================================================================================
def getOnsetStrengthSignal(audio,fs,window_length,overlap_length,fft_length,winType = 'hann',padding = False,smoothing = True,normalization = True,start_sec = 0,end_sec = None):
    
    # Audio Spectrogram
    s,t,_ = getSpectrogram(audio,fs,window_length,overlap_length,fft_length,winType,padding,start_sec)
...
def getBarFeatures(audio,start_sec,end_sec,num,den,configuration,return_time = False):
    ...
    oss,t = getOnsetStrengthSignal(audio,fs,window_length,overlap_length,fft_length,winType,
