...
# =============================================================================
def build_model(input_size,output_size,num_of_units,dropout = 0,mask_value = -1):
    ...
    model.compile(loss = get_masked_loss(mask_value),optimizer = 'adam',
...
# =============================================================================
def train_model(model,train_input,train_output,valid_input = None,valid_output = None,batch_size = 64,epochs = 100,save_period = None,save_history = True):
...
# =============================================================================
def test_model(model,test_input,test_output,save_results = False):
...
# =============================================================================
def plot_history(history,validation = True,epochs = None):
...
# =============================================================================
def build_encoder_decoder(model):
